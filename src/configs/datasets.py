...
datasets_store(datasets_test1, name="test1", metadata = {"description": "Test dataset with 10 subjects"})
datasets_store(datasets_test2, name="test2", metadata = {"description": "Test dataset with 15 subjects"})
