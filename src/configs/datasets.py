...
# CIFAR-10 Full datasets (localhost catalog 2)
datasets_training = [DatasetSpecConfig(rid="3XM", version="0.22.0")]  # Training set with 50,000 images
datasets_testing = [DatasetSpecConfig(rid="3XW", version="0.22.0")]  # Testing set
datasets_split = [DatasetSpecConfig(rid="3XC", version="0.22.0")]  # Split dataset (nested training + testing)
datasets_complete = [DatasetSpecConfig(rid="3X4", version="0.21.0")]  # Complete dataset

# CIFAR-10 Small datasets for quick testing (created with proper execution context)
datasets_small_training = [DatasetSpecConfig(rid="3JHT", version="0.5.0")]  # Small training set with 1,000 images
datasets_small_testing = [DatasetSpecConfig(rid="3JJ2", version="0.4.0")]  # Small testing set with 500 images
datasets_small_split = [DatasetSpecConfig(rid="3R78", version="0.1.0")]  # Small split dataset
