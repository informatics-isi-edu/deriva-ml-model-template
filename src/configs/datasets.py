...
datasets_training = [DatasetSpecConfig(rid="3XT", version="0.5.0")]  # Training set with 50,000 images
datasets_testing = [DatasetSpecConfig(rid="3Y2", version="0.5.0")]  # Testing set
datasets_split = [DatasetSpecConfig(rid="3XJ", version="0.5.0")]  # Split dataset (nested training + testing)
datasets_complete = [DatasetSpecConfig(rid="3XA", version="0.3.0")]  # Complete dataset

# CIFAR-10 Small datasets for quick testing
datasets_small_training = [DatasetSpecConfig(rid="3YW", version="0.5.0")]  # Small training set with 500 images
datasets_small_testing = [DatasetSpecConfig(rid="3Z4", version="0.5.0")]  # Small testing set with 500 images
datasets_small_split = [DatasetSpecConfig(rid="3YM", version="0.5.0")]  # Small split dataset with 1,000 images
